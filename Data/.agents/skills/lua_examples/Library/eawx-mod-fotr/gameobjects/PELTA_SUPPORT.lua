return {
	Ship_Crew_Requirement = 36,
	Fighters = {},
	EmblemData = {
		OPEN_CIRCLE = {
			mesh_to_hide = {"PELTA"},
			mesh_to_reveal = {"PELTA_OCA"},

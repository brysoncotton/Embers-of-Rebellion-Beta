...
function Definitions()
	...
	Attack_Ability_Type_Names = { 
		"InfantryHero",    -- Attack these types.
		"AntiInfantry" -- Stay away from these types.
	}
	Attack_Ability_Weights = { 
		1,             -- attack type weights.
	...
	Escort_Ability_Type_Names = { "Capital", "Frigate", "Corvette" }
	Escort_Ability_Weights = { 10, 10, 5 }

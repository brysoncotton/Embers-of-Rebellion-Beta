...
function Definitions()
	...
	Attack_Ability_Type_Names = { 
		"Infantry", "Vehicle", "AirGunship", "AirSpeeder", 	      		-- Attack these types.
	...
	Escort_Ability_Type_Names = { "Infantry", "Vehicle", "AirGunship", "AirSpeeder", "Field_Com_Rebel_Team", "Field_Com_Empire_Team" }

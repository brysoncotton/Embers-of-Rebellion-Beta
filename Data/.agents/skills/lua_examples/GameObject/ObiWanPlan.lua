...
function Definitions()
	...
	Escort_Ability_Type_Names = { "Infantry", "Vehicle", "AirGunship", "AirSpeeder", "Fleet_Com_Rebel_Team", "Fleet_Com_Empire_Team" }
...
function Unit_Prox(self_obj, trigger_obj)
	...
	if trigger_obj.Is_Category("InfantryHero") then
		return
	end	

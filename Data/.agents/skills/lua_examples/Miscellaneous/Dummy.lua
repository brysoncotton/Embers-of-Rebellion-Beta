...
function mov()
	Find_First_Object("CR90").Move_To(Find_First_Object("Skirmish_Empire_Star_Base_1"))
	MessageBox("Moved")
end
...
function stest()
	MessageBox("%s", tostring((Find_First_Object("X_Wing").Get_Parent_Object()).Move_To(Find_First_Object("IPV1"))))
end

function ref()
	Reinforce_Unit(Find_Object_Type("CR90"), false, Find_Player("Rebel"), true, false)
end
...
function move()
	...
	ReinforceList(unit_list, Find_First_Object("CR90"), Find_Player("Rebel"), false, true, true, test_call)
...
function one()
	Spawn_Unit(Find_Object_Type("Rebel_Heavy_Tank_Brigade"), Find_First_Object("Power_Generator"), Find_Player("Rebel"))
end

function two()
	Spawn_Unit(Find_Object_Type("CR90"), Find_First_Object("Skirmish_Rebel_Star_Base_1"), Find_Player("Rebel"))
end

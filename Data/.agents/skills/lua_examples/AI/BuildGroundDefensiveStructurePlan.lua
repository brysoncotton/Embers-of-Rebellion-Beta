...
--	Category = "Build_Ground_Defensive_Structure"
	...
	{
		"StructureForce",
		"Ground_Base_Shield | Ground_Umbrella_Shield | Galactic_Turbolaser_Tower_Defenses | Galactic_Turbolaser_Tower_Defenses_Republic | Galactic_Turbolaser_Tower_Defenses_CIS = 1"
	}
	}

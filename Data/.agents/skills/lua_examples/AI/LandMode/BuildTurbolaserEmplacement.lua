...
function Definitions()
	...
	Category = "Build_Field_Turbolaser_Emplacement"
	TaskForce = {
	{
		"MainForce"					
		,"TaskForceRequired"
		,"UC_Generic_Field_Turbolaser_Emplacement | UC_Generic_Field_Turbolaser_Emplacement_Republic | UC_Generic_Field_Turbolaser_Emplacement_CIS = 1"
	}
	}
	pad = nil
	good_pad = nil

...
function Begin_Battle(message)
	if message == OnEnter then
		...
		MissionUtil.Set_To_Allies(p_invaders, p_cis)
...
function State_Padme_Reached(prox_obj, trigger_obj)
	if TestValid(trigger_obj) then
		if trigger_obj == player_anakin then
			...
			MissionUtil.PlayGenericSpeech("Subjugator_Sabotage_02")
			Stop_All_Music()
...
function State_Bridge_Reached(prox_obj, trigger_obj)
	if TestValid(trigger_obj) then
		...
		if anakin_reached_bridge and padme_reached_bridge then
			...
			MissionUtil.SpawnListSpawner("B1_DROID_MARINE_SQUAD", patrol_loop_1_2_marker, p_cis, 1)
			MissionUtil.SpawnListSpawner("B1_DROID_MARINE_SQUAD", patrol_loop_2_2_marker, p_cis, 1)
			MissionUtil.SpawnListSpawner("B1_DROID_MARINE_SQUAD", patrol_loop_3_2_marker, p_cis, 1)
			MissionUtil.SpawnListSpawner("B1_DROID_MARINE_SQUAD", patrol_loop_4_2_marker, p_cis, 1)

			MissionUtil.SpawnListSpawner("BX_COMMANDO_SQUAD", patrol_loop_1_4_marker, p_cis, 1)
			MissionUtil.SpawnListSpawner("BX_COMMANDO_SQUAD", patrol_loop_2_4_marker, p_cis, 1)
			MissionUtil.SpawnListSpawner("BX_COMMANDO_SQUAD", patrol_loop_3_4_marker, p_cis, 1)
			MissionUtil.SpawnListSpawner("BX_COMMANDO_SQUAD", patrol_loop_4_4_marker, p_cis, 1)

			MissionUtil.PlayGenericSpeech("Subjugator_Sabotage_03")
			Stop_All_Music()
			Play_Music("Silence_Theme")
			...
			if cinematic_four then
				if not cinematic_four_skipped then
					...
					if not TestValid(player_grievous) then
						player_grievous = MissionUtil.SpawnUnitGround("GENERAL_GRIEVOUS", midtro_1_grievous_marker, p_cis)
						player_grievous.Set_Garrison_Spawn(false)

						player_magna_1 = MissionUtil.SpawnUnitGround("MAGNAGUARD", midtro_1_magna_1_marker, p_cis)
						player_magna_2 = MissionUtil.SpawnUnitGround("MAGNAGUARD", midtro_1_magna_2_marker, p_cis)
					end
...
function Start_Cinematic_Intro_Rep()
	...
	MissionUtil.PlayGenericSpeech("Subjugator_Sabotage_01")
...
function Start_Cinematic_Midtro_03_Rep()
	...
	MissionUtil.PlayGenericSpeech("Subjugator_Sabotage_04")
	MissionUtil.PlayGenericMusic("Silence_Theme")
...
function Start_Cinematic_Outro_Rep()
	...
	MissionUtil.PlayGenericSpeech("Subjugator_Sabotage_05")
	MissionUtil.PlayGenericMusic("Silence_Theme")
	...
	player_outro_pilot_1 = MissionUtil.SpawnUnitGround("B1_DROID", outro_1_pilot_1_marker, p_cis)
	player_outro_pilot_2 = MissionUtil.SpawnUnitGround("B1_DROID", outro_1_pilot_2_marker, p_cis)
	player_outro_pilot_3 = MissionUtil.SpawnUnitGround("B1_DROID", outro_1_pilot_3_marker, p_cis)
